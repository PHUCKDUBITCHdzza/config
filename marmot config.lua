...
getgenv().gagConfig = {
    ...
    KEEP_PETS = { ["Corrupted Kodama"] = 4, "Corrupted Kitsune", ["Starfish"] = 3, ["Koi"] = 4, "Kitsune", ["Kappa"] = 3, "Fennec Fox", "Disco Bee", "Raccoon", "Queen Bee", "Dragonfly", "Butterfly", "Mimic Octopus", "Brontosaurus", "T-Rex", "Spinosaurus", "Ankylosaurus", "Dilophosaurus", "Capybara", [ "Seal"] = 4, "Red Fox", "Tanchozuru", ["Tanuki"] = 3, "Ostrich", ["Raiju"] = 2},
    KEEP_PETS_WEIGHT = 6,
